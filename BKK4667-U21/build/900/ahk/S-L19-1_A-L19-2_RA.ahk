global OffsetX := 3
global OffsetY := 26
global InputFileName = "S-L19-1_A-L19-2_RA"
...
PerformActionTab1() {
	...
	SendMessage, 0x0C, , "Amara Bangkok Hotel (BKK4667-U21) S-L19-1_A-L19-2 (RA)", WindowsForms10.EDIT.app.0.33c0d9d1, ^Plot Properties
	Send, !a
}
...
PerformActionTab3() {
	...
	Send, {Shift down}{Home}{Shift up}{Del}-15.6 ; Type limit
