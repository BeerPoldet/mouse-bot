global OffsetX := 3
global OffsetY := 26
global InputFileName = "S-L19-1_A-L19-2_CL"
global InputFilePath = "C:\Users\Poldet\dev\workspaces\mobicat\mouse-bot\BKK4667-U21\line_sweep_tools\1800"
global BuildPath = "C:\Users\Poldet\dev\workspaces\mobicat\mouse-bot\BKK4667-U21\build\1800"
...
PerformActionTab1() {
	...
	SendMessage, 0x0C, , "Cable Loss", WindowsForms10.EDIT.app.0.33c0d9d2, ^Plot Properties
	SendMessage, 0x0C, , "Amara Bangkok Hotel (BKK4667-U21) S-L19-1_A-L19-2 (Short Test)", WindowsForms10.EDIT.app.0.33c0d9d1, ^Plot Properties
	Send, !a
}
...
PerformActionTab2() {
	...
	Control, Choose, 2, WindowsForms10.COMBOBOX.app.0.33c0d9d1, ^Plot Properties
	Send, !a
}
...
PerformActionTab3() {
	...
	Send, {TAB 4}{Del}0 ; Type top
	Send, {TAB 1}{Del}-5 ; Type bottom
	ControlClick, % Coord(397, 134), A ; Choose Meters

	ControlClick, % Coord(152, 184), A ; Choose Single Value
	Sleep, 350
	ControlClick, % Coord(110, 230), A ; Choose Limit Line Off
